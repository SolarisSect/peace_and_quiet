function txt_peace() { //silence.
	...
	txt("Good afternoon, Myoku!", TAMAKO.SMILING),
	...
	txt("Blah blah blah, I can't hear you over the sound of you being such an absolute dork.", MYOKU.SMILING),
    ...
    txt("Here, you sit here- and I'll just-", AISAKO.SMILING),
    txt("The tanuki disappeared in a cloud of smoke and leaves, leaving the kitsune slightly surprised."), 
    txt("Aisako?", MYOKU.FROWNING), 
    txt("The kitsune turned around, seeing the tanuki politely walking up, sitting back down next to her."), 
    txt("... that felt stupid, I shouldn't do that again.", AISAKO.FROWNING),
    txt("Please don't, I thought you were just gonna leave me.", MYOKU.FROWNING), 
    txt("... my bad.", AISAKO.FROWNING),
